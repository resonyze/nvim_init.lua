...
require('lazy').setup({
  ...
  -- Too used to this plugin
  'tpope/vim-surround',

  -- Undo tree recommended by primeagen
  {
    'mbbill/undotree',
    config = function ()
  ...
  -- Makes code actions look better
...

  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "CursorLine", { bg = "#2d2d2d", bold = true, })
      -- https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/palette/nightfox.lua
      vim.api.nvim_set_hl(0, "LspInfoBorder", { fg = "#cdcecf" })
    end
  },
...
require("flutter-tools").setup {
  ...
  lsp = {
    color = { -- show the derived colours for dart variables
      ...
      background_color = { r = 25, g = 35, b = 48},
